...
namespace Sklad.Views
{
    ...
    public partial class detailsPage : ContentPage
    {
        ...
        private ItemC ToUpdate = new ItemC("", "", true, "");
        ...
        public detailsPage(Item item)
        {
            ...
            ToUpdate.Edit = true;
            ToUpdate.Available = item.Available;
            ToUpdate.Brench = item.Brench;
        ...
        {
            Navigation.PushAsync(new Sklad.Views.editItem(ToUpdate));
        }
    }
}